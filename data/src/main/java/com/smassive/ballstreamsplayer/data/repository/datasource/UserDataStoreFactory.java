...
public class UserDataStoreFactory {
    ...
    public UserDataStore create(boolean refresh) {
        if (refresh) {
    ...
    public DbUserDataStore createLocalDataStore() {
        return new DbUserDataStore(context);
    }

    public CloudUserDataStore createRemoteDataStore() {
