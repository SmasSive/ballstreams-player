...
public class GetUserUseCaseTest {
    ...
    private static final String FAKE_USERNAME = null;

    private static final String FAKE_PASSWORD = null;
    ...
    public void setUp() {
        ...
        getUserUseCase = new GetUserUseCase(mockUserRepository, mockThreadExecutor, mockPostExecutionThread);
    }

    @Test
    public void testGetUserUseCaseOk() {
        getUserUseCase.buildUseCaseObservable();

        verify(mockUserRepository).getUser(FAKE_USERNAME, FAKE_PASSWORD);
